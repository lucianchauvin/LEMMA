...
test("Course Statements Page - Student Cannot Navigate to Course Statements", async ({ page }) => {
...
test("Course Statements Page - Instructor Can Navigate to Course Statements", async ({ page }) => {
    // Navigate to login page
    await page.goto("http://localhost:3000/login")
...
test("Course Statements Page - Admin Can Navigate to Course Statements", async ({ page }) => {
    // Navigate to login page
    await page.goto("http://localhost:3000/login")
...
test("Course Statements Page - Instructor Can Click on LEMMA Icon to Return to Home Page", async ({ page }) => {
    // Navigate to login page
    await page.goto("http://localhost:3000/login")
...
test("Course Statements Page - Admin Can Click on LEMMA Icon to Return to Admin Panel Page", async ({ page }) => {
    // Navigate to login page
    await page.goto("http://localhost:3000/login")
...
test("Course Statements Page - Instructor Can Click on Home Page Icon in Sidebar to Return to Home Page", async ({ page }) => {
    // Navigate to login page
    await page.goto("http://localhost:3000/login")
...
test("Course Statements Page - Admin Can Click on Home Page Icon in Sidebar to Return to Admin Panel Page", async ({ page }) => {
    // Navigate to login page
    await page.goto("http://localhost:3000/login")
