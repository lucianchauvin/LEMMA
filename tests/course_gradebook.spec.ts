...
test("Course Gradebook Page - (Integration Test) Correct Information is Displayed After Edit and Instructor Can View Course Gradebook", async ({ page }) => {
    // Navigate to login page
    await page.goto("http://localhost:3000/login")
...
test("Course Gradebook Page - (Integration Test) Correct Information is Displayed After Edit and Admin Can View Course Gradebook", async ({ page }) => {
    // Navigate to login page
    await page.goto("http://localhost:3000/login")
